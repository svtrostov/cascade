...
define('FPDF_FONTPATH',DIR_CLASSES.'/PDF_FONTS/');
...
function _textEncode($text=''){
	return (mb_detect_encoding($text, 'UTF-8', true) ? iconv('UTF-8','windows-1251',$text) : $text);
}
...
function _putinfo()
{
	if(empty($this->producer)) $this->producer = 'PDF';
