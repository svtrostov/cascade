...
class Request{
	...
	protected function init(){
		...
		#AJAX запрос
		$this->request['ajax'] = ($this->isAjax() ? true : $this->getBool('ajax',false));
	...
	public function getFloat($key=null, $default=0, $gpc='pg'){
		return floatval($this->getGPC($key, $default, $gpc));
	}#end function
	...
	public function getHash($key=null, $default=false, $gpc='pg'){
		...
		return empty($pwd) ? $default : User::_getHash($pwd);
	}#end function
