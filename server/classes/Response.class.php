<?php
/*==================================================================================================
Описание: Обработка заголовков ответа и Cookies
...
class Response{
	...
	public function sendHeaders(){
		...
		if(($this->sent = headers_sent())!==false) return debugError(array(
			'id'		=> 'ERESP001',
			'desc'		=> 'Нельзя отправить заголовки ответа, т.к. уже был вывод',
			'return'	=> false,
			'file'		=> __FILE__,
			'line'		=> __LINE__,
			'class'		=> __CLASS__,
	...
	public function add($key, $value=null){
		...
		if(($this->sent = headers_sent())!==false) return debugError(array(
			'id'		=> 'ERESP002',
			'desc'		=> 'Попытка добавить заголовки ответа в то время, когда уже был вывод',
			'return'	=> false,
			'file'		=> __FILE__,
			'line'		=> __LINE__,
			'class'		=> __CLASS__,
