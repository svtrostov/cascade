...
class Session{
	...
	public function xread($session_id){
		return (string)xcache_get('sess/'.$this->session_name.'/'.$session_id);
	}

	public function xwrite($session_id, $session_data){
		return xcache_set('sess/'.$this->session_name.'/'.$session_id, $session_data, Session::$session_expire);
	}

	public function xdestroy($session_id){
		xcache_unset('sess/'.$this->session_name.'/'.$session_id);
		return true;
	}
	...
	public function xexists($session_id){
		return xcache_isset('sess/'.$this->session_name.'/'.$session_id);
	}
