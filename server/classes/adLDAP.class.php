...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@corp.groupmegapolis.ru";
    ...
    * @var string
    */
	protected $baseDn = "DC=corp,DC=groupmegapolis,DC=ru"; 
    ...
    * @var array
    */
    protected $domainControllers = array("corp.groupmegapolis.ru");
    ...
    */
    public function connect() 
    {
        ...
        ldap_set_option($this->ldapConnection, LDAP_OPT_SIZELIMIT, 99999);
