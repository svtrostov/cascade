...
class adLDAPUsers {
    ...
    */
    public function create($attributes)
    {
        ...
        if (!array_key_exists("canonical_name", $attributes)){ return "Missing compulsory field [canonical_name]"; }
        ...
        $add["cn"][0] = $attributes["canonical_name"];
        ...
        if ($result != true) {
			print_r(ldap_error($this->adldap->getLdapConnection())); 
			print_r($add); 
            return false; 
        }
